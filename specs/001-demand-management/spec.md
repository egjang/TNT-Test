...
- [ ] FR-5: 선택된 엑셀의 첫 번째 시트를 미리보기로 표 형태로 보여준다(최대 100행 × 20열)
- [ ] FR-6: 다중 시트일 경우 시트를 선택할 수 있는 드롭다운을 제공한다
...
- [ ] AC-4: 파일 선택 시 첫 시트 내용이 표로 미리보기 된다(100행/20열 제한 반영)
- [ ] AC-5: 다중 시트 파일에서 시트를 바꾸면 해당 시트 내용이 미리보기로 갱신된다
