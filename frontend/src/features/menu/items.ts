  ...
  const items: (MenuItem | null)[] = [
    ...
    { key: 'complaint', label: 'Complaint', icon: AlertCircle },
    {
      ...
      children: [
        ...
        { key: 'lab:tnt-chat', label: '대화해! TNT' },
        { key: 'lab:google-rag', label: 'Google RAG (참조)' },
        ...
        { key: 'lab:standard-ui-cd1', label: 'Standard UI 1 (CD)' },
        { key: 'lab:standard-ui-cd2', label: 'Standard UI 2 (CD)' },
        { key: 'lab:standard-ui-cd3', label: 'Standard UI 3 (CD)' },
        { key: 'lab:standard-nav1', label: 'Standard Navigation 1' },
        { key: 'lab:standard-nav2', label: 'Standard Navigation 2' },
        { key: 'lab:standard-nav3', label: 'Standard Navigation 3' },
